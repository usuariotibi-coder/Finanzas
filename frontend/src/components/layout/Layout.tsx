  ...
  return (
    <div className="h-screen bg-neutral-50 text-primary-900 flex flex-col overflow-hidden">
      ...
      <div className="mt-16 flex h-[calc(100vh-4rem)] overflow-hidden">
        ...
        <main className={`flex-1 min-w-0 min-h-0 overflow-hidden transition-all duration-300 ${sidebarOpen ? 'ml-48' : 'ml-0'}`}>
          <div className="h-full min-h-0 overflow-y-auto overflow-x-hidden">
            <div className="mx-auto box-border flex h-full min-h-0 w-full max-w-[2160px] flex-col px-2 py-2 sm:px-3 sm:py-2.5 lg:px-5 xl:px-6 2xl:px-8">
              {children}
            </div>
          </div>
        </main>
